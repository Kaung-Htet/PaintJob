public class PaintJob {
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        if (width > 0 && height > 0 && areaPerBucket > 0 && extraBuckets >= 0) {
            //area Bob has to paint
            double areaToPaint = width * height;
            double requiredBucketsToUse = areaToPaint / areaPerBucket;
//            int bucketsToBuy = (int) (Math.ceil (requiredBucketsToUse - extraBuckets));
//            return bucketsToBuy;
            return (int) (Math.ceil(requiredBucketsToUse - extraBuckets));
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket) {
        ...
        if (width > 0 && height > 0 && areaPerBucket > 0) {
            //area Bob has to paint
            double areaToPaint = width * height;
//            int requiredBucketsToUse = (int) Math.ceil (areaToPaint / areaPerBucket);
//            return requiredBucketsToUse;
...
//            int requiredBucketsToUse = (int) Math.ceil (area / areaPerBucket);
//            return requiredBucketsToUse;
